...
i have cloned the this website based on the theme

The assigned task [Task](https://themes.themesbrand.com/appspery/react/)

## Demo

Visit the live demo [here](https://nexa-analytics.netlify.app/).
